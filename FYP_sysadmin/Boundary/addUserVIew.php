...
<div class="Login">
    ...
    <form action="addUserAction.php" method="post">
        <label>
            <span>SIM ID: </span>
            <input type="text" class="put" name="simID" placeholder="Enter SIM ID" required>
        </label>
        <label>
            <span>Institute ID: </span>
            <input type="text" class="put" name="instituteID" placeholder="Enter Institute ID"
        </label>
        <label>
            <span>Name: </span>
            <input type="text" class="put" name="name" placeholder="Enter Name" required>
        </label>
        <label>
            <div class="shang">
                <span>Gender: </span>
                <input type="radio" id="blankCheckbox" name="gender" value="male" checked>Male
                <input type="radio" id="blankCheckbox" name="gender" value="female" >Female
            </div>
        </label>
        <label>
            <span>Age: </span>
            <input type="text" class="put" name="age" placeholder="Age" required>
        </label>
        <label>
            <span>Institute: </span>
            <input type="text" class="put" name="institute" placeholder="Enter Institute" required>
        </label>
        <label>
            <span>Phone Number: </span>
            <input type="text" class="put" name="phone_number" placeholder="Enter Phone Number" required>
        </label>
        <label>
            <span>Bit Map Data: </span>
            <input type="text" class="put" name="bitmap" placeholder="bitmap here update latter" value=null required>
        </label>
